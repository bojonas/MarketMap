...
export default function MiniMap({ layout, market, selectMarket, images }) {
  const [dimensions, setDimensions] = useState({ width: '8svw', height: '7svh' });
  ...
  return (
    <div className='flex items-center justify-center w-[30%] p-[2%]'>
        <div ref={ref} style={dimensions}>
          <div onClick={() => selectMarket(market)}className='grid w-fit h-fit bg-darkgray-custom overflow-hidden rounded-xl cursor-pointer border-custom-hover border-[0.4svh] border-gray-custom' 
            style={{ 
