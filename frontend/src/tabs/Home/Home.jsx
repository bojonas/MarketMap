...
export default function Home() {
    ...
    const selectMarket = async (market) => {  
        ...
        else document.documentElement.style.setProperty('--navbar-color',  document.documentElement.style.getPropertyValue('--custom-color') || '#715DF2');
        ...
        else document.documentElement.style.setProperty('--navbar-border-color',  document.documentElement.style.getPropertyValue('--custom-color') || '#715DF2');
